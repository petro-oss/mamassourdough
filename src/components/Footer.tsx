    ...
    <footer className="bg-[#2C1A0E] text-[#A07850]">
      ...
      <div className="border-t border-[#4A2E1A] max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6">
          ...
          <div>
            <p className="font-mono text-[9px] tracking-[0.2em] uppercase text-[#4A6741] mb-1">Cliftonville</p>
          ...
          <div>
            <p className="font-mono text-[9px] tracking-[0.2em] uppercase text-[#4A6741] mb-1">Cliffsend</p>
